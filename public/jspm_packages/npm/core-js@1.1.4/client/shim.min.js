  ...
  !function(b, c, a) {
    ...
    !function(b) {
      ...
      var e = b(2),
          ...
          r = u ? function() {
            try {
              return k(h({}, c, {get: function() {
                  return h(this, c, {value: !1})[c];
                }}))[c] || h;
            } catch (a) {
          ...
          I = function(a) {
            var b = i[a] = k(f.prototype);
            return b._k = a, u && m && r(j, a, {
              configurable: !0,
              set: function(b) {
                d(this, c) && d(this[c], a) && (this[c][a] = !1), r(this, a, p(1, b));
              }
            }), b;
          },
          q = function defineProperty(a, b, e) {
            return e && d(i, b) ? (e.enumerable ? (d(a, c) && a[c][b] && (a[c][b] = !1), e = k(e, {enumerable: p(0, !1)})) : (d(a, c) || h(a, c, p(1, {})), a[c][b] = !0), r(a, b, e)) : h(a, b, e);
          },
          ...
          E = function create(b, c) {
            return c === a ? k(b) : v(k(b), c);
          },
          D = function propertyIsEnumerable(a) {
            var b = J.call(this, a);
            return b || !d(this, a) || !d(i, a) || d(this, c) && this[c][a] ? b : !0;
          },
          C = function getOwnPropertyDescriptor(a, b) {
            var e = H(a = n(a), b);
          ...
          x = function getOwnPropertySymbols(f) {
            for (var a,
                b = y(n(f)),
                c = [],
                e = 0; b.length > e; )
      ...
      }, s(f.prototype, "toString", function toString() {
        return this._k;
      }), e.create = E, e.isEnum = D, e.getDesc = C, e.setDesc = q, e.setDescs = v, e.getNames = B.get = A, e.getSymbols = x, u && !b(37) && s(j, "propertyIsEnumerable", D, !0)), (!l || b(4)(function() {
        return "[{},[null]]" != JSON.stringify([{a: f()}, [f()]]);
      })) && s(f.prototype, "toJSON", function toJSON() {
        return l && L(this) ? this : void 0;
      });
      var w = {
        "for": function(a) {
          return d(o, a += "") ? o[a] : o[a] = f(a);
        },
      ...
      e.each.call("hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), function(a) {
        var b = z(a);
        w[a] = l ? b : I(b);
      }), m = !0, g(g.G + g.W, {Symbol: f}), g(g.S, "Symbol", w), g(g.S + g.F * !l, "Object", {
        create: E,
        defineProperty: q,
        defineProperties: v,
      ...
      }), t(f, "Symbol"), t(Math, "Math", !0), t(F.JSON, "JSON", !0);
    }, function(d, f, e) {
      var a = e(7),
      ...
      }), i.constructor = b, b.prototype = i, c(15)(g, "RegExp", b))), c(116)(b);
    }, function(a, d, b) {
      var c = b(26);
      a.exports = function() {
        var b = c(this),
      ...
      b(125)("replace", 2, function(b, c, d) {
      ...
      var w,
          ...
          C = function(a) {
            return u(a) && (f ? "Promise" == z(a) : i in a);
          },
          D = function(a, b) {
            ...
            if (!b.n) {
              ...
              v(function() {
                ...
                c.length = 0, b.n = !1, d && setTimeout(function() {
                  B(b.p) && (E ? x.emit("unhandledRejection", e, b.p) : n.console && console.error && console.error("Unhandled promise rejection", e)), b.a = a;
                }, 1);
              });
            }
          },
      ...
      })), d(d.G + d.W + d.F * !f, {Promise: c}), b(32)(c, e), o(c), o(w = b(13)[e]), d(d.S + d.F * !f, e, {reject: function reject(a) {
      ...
      d.exports = function(i, r, u, q, k, j) {
        ...
        if ("function" == typeof d && (j || h.forEach && !b(4)(function() {
          ...
          d = q.getConstructor(r, i, k, l), b(134)(d.prototype, u);
        return b(32)(d, i), s[i] = d, c(c.G + c.W + c.F * (d != n), s), j || q.setStrong(d, i, k), d;
      };
    }, function(c, d, a) {
      var b = a(136);
      a(137)("Set", function(a) {
        return function Set() {
          return a(this, arguments[0]);
        };
      }, {add: function add(a) {
