...
},{"../../components/factories/pixi_horizontalHexaFactory":93,"../../components/map/core/utils/utils":102,"../../tests/data/gameData":108,"../../tests/data/pixi_mapData":109,"../../tests/data/pixi_typeData":110,"babel/polyfill":92}],2:[function(require,module,exports){
(function (global){
"use strict";
...
var _mapCorePixi_eventlisteners = require('../map/core/pixi_eventlisteners');
...
function createMap(canvasElement, datas) {
  ...
  document.getElementById('testFullscreen').addEventListener('click', function () {
    _mapCorePixi_eventlisteners.eventListeners.toggleFullScreen();
  });
...
},{"../map/core/pixi_Map":96,"../map/core/pixi_eventlisteners":100,"../map/core/pixi_spritesheetList":101,"../map/core/utils/utils":102,"../map/extensions/hexagons/object/pixi_Object_terrain_hexa":104,"../map/extensions/hexagons/object/pixi_Object_unit_hexa":105}],94:[function(require,module,exports){
'use strict';
...
},{"../pixi_Object":99}],95:[function(require,module,exports){
'use strict';
...
},{"../pixi_Object":99}],96:[function(require,module,exports){
...
var _pixi_eventlisteners = require('./pixi_eventlisteners');
...
var Map = (function () {
  ...
  function Map(canvas, options) {
    ...
    _stage = new _pixi_Map_stage.Map_stage('mainStage', canvas, _renderer);
    ...
    eventlisteners = (0, _pixi_eventlisteners.eventListeners)(this, canvas);
...
},{"./pixi_Map_layer":97,"./pixi_Map_stage":98,"./pixi_eventlisteners":100,"./utils/utils":102}],97:[function(require,module,exports){
"use strict";
...
var Map_stage = (function (_PIXI$Stage) {
  /**
   * @param {String} name layer property name, used for identifiying the layer, usefull in debugging, but used also
   * otherwise too!
  ...
  */
  ...
  function Map_stage(name, canvas, renderer) {
    ...
    _get(Object.getPrototypeOf(Map_stage.prototype), "constructor", this).call(this, "#FFFFFF");
  ...
  _inherits(Map_stage, _PIXI$Stage);
...
},{"../utils/hexagonMath":106,"../utils/pixi_createHexagon":107}],104:[function(require,module,exports){
'use strict';
...
},{"../../../core/objects/pixi_Object_sprite_terrain":94,"./pixi_Object_hexa":103}],105:[function(require,module,exports){
'use strict';
...
},{"../../../core/objects/pixi_Object_sprite_unit":95,"./pixi_Object_hexa":103}],106:[function(require,module,exports){
"use strict";
